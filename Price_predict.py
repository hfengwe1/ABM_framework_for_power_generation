...
Data_dir = "c:/School/SloanProject/ABM_Model/SloanABM/Data/"
# os.chdir(Data_dir)
...
#    LZ = ['LZ_AEN', 'LZ_CPS','LZ_HOUSTON','LZ_NORTH','LZ_SOUTH','LZ_WEST', 'LZ_LCRA', 'LZ_RAYBN']  
    if text == "demand":
        folder = "C:/School/SloanProject/ABM_Model/SloanABM/Data/Future_Data/Demand/"

    elif text == "price":
        folder = "C:/School/SloanProject/ABM_Model/SloanABM/Data/Future_Data/Price/"
...
# this function applies linear regression on the most recent 10-year data (ERCOT's total demand and capacity)
# output is a linear model for agents to estimate capacity deficit. 

def Capacity_predict(df):
    linear = []  # create an empty list for the linear fucntion 
